...
def compare_directories(outdir, regression_dir, tolerance, results_file):
    ...
    for data_file in data_files:
        ...
        try:
            diff_results = approximateDiff(
                os.path.join(outdir, data_file),
                os.path.join(regdir, data_file),
                tolerance,
            )
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise Exception(
            "*** Must specify output directory, and optionally regression directory"
        )
