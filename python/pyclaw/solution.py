...
class Dimension(object):
    ...
    def qbc_lower(self, grid, qbc):
        ...
        # Solid wall bc
            ...
            raise NotImplementedError(
                "Solid wall upper boundary condition not implemented."
            )
        else:
            raise NotImplementedError(
                "Boundary condition %s not implemented" % self.mthbc_lower
            )
    ...
    def qbc_upper(self, grid, qbc):
        ...
        # Solid wall bc
            ...
            raise NotImplementedError(
                "Boundary condition %s not implemented" % self.mthbc_upper
            )
...
class Grid(object):
    ...
    def mthbc_lower():
        ...
        def fget(self):
            return self.get_dim_attribute("mthbc_lower")

        def fset(self, value):
            [
                setattr(getattr(self, dim), "mthbc_lower", value)
    ...
    def mthbc_upper():
        ...
        def fget(self):
            return self.get_dim_attribute("mthbc_upper")

        def fset(self, value):
            [
                setattr(getattr(self, dim), "mthbc_upper", value)
                for dim in self._dimensions
            ]
        ...
        for dim in self.dimensions:
            if dim.mthbc_lower == 0:
                try:
                    ...
                    logger.debug(
                        "Lower BC function for %s has not been set." % dim.name
                    )
                    valid = False
                except:
                    pass
            if dim.mthbc_upper == 0:
                try:
                    ...
                    logger.debug(
                        "Upper BC function for %s has not been set." % dim.name
                    )
                    valid = False
                except:
                    pass
    ...
    def qbc(self):
        ...
        dim_string = ",".join(
            ("2*self.mbc+self.%s.n" % name for name in self._dimensions)
        )
        ...
        if recompute or not len(self._p_center) == len(self._dimensions):
            ...
            # Higer dimensional calculate center arrays
                ...
                for center_array in self.get_dim_attribute("center"):
                    exec(
                        "array_list.append(np.reshape(center_array[index[%i,%s]],(array_length)))"
                        % (i, index_str)
                    )
                    i += 1
                ...
                for i in range(self.ndim):
                    self._p_center[i] = np.reshape(p[i], self.get_dim_attribute("n"))
    ...
    def compute_p_edge(self, recompute=False):
        ...
        if recompute or not len(self._p_edge) == len(self._dimensions):
            ...
            if self.ndim == 1:
                ...
                # Calculate length of full arrays and indexing string
                array_length = reduce(
                    lambda x, y: x * y, [n + 1 for n in self.get_dim_attribute("n")]
                )
                index_str = ",".join(
                    ("0:self.%s.n+1" % dim for dim in self._dimensions)
                )
                ...
                for edge_array in self.get_dim_attribute("edge"):
                    exec(
                        "array_list.append(np.reshape(edge_array[index[%i,%s]],(array_length)))"
                        % (i, index_str)
                    )
                    i += 1
                ...
                # Reshape arrays for storage
                for i in range(self.ndim):
                    self._p_edge[i] = np.reshape(
                        p[i], [n + 1 for n in self.get_dim_attribute("n")]
                    )
    ...
    def compute_c_center(self, recompute=False):
        ...
        if recompute or not len(self._c_center) == len(self._dimensions):
            ...
            if self.ndim == 1:
                ...
                for i in range(self.ndim):
                    exec(
                        "self._c_center[i] = self.dimensions[i].center[index[i,%s]]"
                        % index_str
                    )
    ...
    def compute_c_edge(self, recompute=False):
        ...
        if recompute or not len(self._c_edge) == len(self._dimensions):
            ...
            if self.ndim == 1:
                ...
                for i in range(self.ndim):
                    exec(
                        "self._c_edge[i] = self.dimensions[i].edge[index[i,%s]]"
                        % index_str
                    )
...
class Solution(object):
    ...
    def t():
        ...
        def fget(self):
            return self._get_base_grid_attribute("t")

        def fset(self, value):
            self.set_all_grids("t", value)
    ...
    def meqn():
        ...
        def fget(self):
            return self._get_base_grid_attribute("meqn")

        def fset(self, value):
            self.set_all_grids("meqn", value)
    ...
    def mbc():
        ...
        def fget(self):
            return self._get_base_grid_attribute("mbc")

        def fset(self, value):
            self.set_all_grids("mbc", value)
    ...
    def q():
        ...
        def fget(self):
            return self._get_base_grid_attribute("q")
    ...
    def aux():
        ...
        def fget(self):
            return self._get_base_grid_attribute("aux")
    ...
    def capa():
        ...
        def fget(self):
            return self._get_base_grid_attribute("capa")
    ...
    def aux_global():
        ...
        def fget(self):
            return self._get_base_grid_attribute("aux_global")
    ...
    def maux():
        ...
        def fget(self):
            return self._get_base_grid_attribute("maux")
    ...
    def mthbc_lower():
        ...
        def fget(self):
            return self._get_base_grid_attribute("mthbc_lower")

        def fset(self, value):
            self.set_all_grids("mthbc_lower", value)
    ...
    def mthbc_upper():
        ...
        def fget(self):
            return self._get_base_grid_attribute("mthbc_upper")

        def fset(self, value):
            self.set_all_grids("mthbc_upper", value)
    ...
    def set_all_grids(self, attr, value, overwrite=True):
        ...
        [
            ...
            for grid in self.grids
            if getattr(grid, attr) is None or overwrite
        ]
    ...
    def write(
        ...
        for form in format_list:
            ...
            if file_prefix is None:
                write_func(self, frame, path, write_aux=write_aux, options=options)
            else:
                write_func(
                    self,
                    frame,
