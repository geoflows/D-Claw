...
all_white = make_colormap({0.0: "w", 1.0: "w"})
all_light_red = make_colormap({0.0: "#ffdddd", 1.0: "#ffdddd"})
all_light_blue = make_colormap({0.0: "#ddddff", 1.0: "#ddddff"})
all_light_green = make_colormap({0.0: "#ddffdd", 1.0: "#ddffdd"})
all_light_yellow = make_colormap({0.0: "#ffffdd", 1.0: "#ffffdd"})

red_white_blue = make_colormap({0.0: "r", 0.5: "w", 1.0: "b"})
blue_white_red = make_colormap({0.0: "b", 0.5: "w", 1.0: "r"})
red_yellow_blue = make_colormap({0.0: "r", 0.5: "#ffff00", 1.0: "b"})
blue_yellow_red = make_colormap({0.0: "b", 0.5: "#ffff00", 1.0: "r"})
yellow_red_blue = make_colormap({0.0: "#ffff00", 0.5: "r", 1.0: "b"})
white_red = make_colormap({0.0: "w", 1.0: "r"})
white_blue = make_colormap({0.0: "w", 1.0: "b"})
