...
oso_fs_colormap = colormaps.make_colormap({0.0: blue,
                                           30.0: red})

oso_phi_colormap = colormaps.make_colormap({0.0: blue,
                                            0.75: red})

oso_taudir_colormap = colormaps.make_colormap({0.0: blue,
                                           1.0: red})

oso_cohesion_colormap = colormaps.make_colormap({0.0: blue,
                                           1.e6: red})
...
"bathy1":bathy1_colormap,"bathy2":bathy2_colormap,"runoutpad":runoutpad_colormap,"oso_land":oso_land_colormap}
